...
SECRET_KEY = 'oe-)mdhz&6#vx#=gb4-y+0nfq6i-hk4ke59*w+=o+(!8_^94is'
...
ROOT_URLCONF = 'plateforme_budgetaire.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            BASE_DIR + '/plateforme_budgetaire/templates/'
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'plateforme_budgetaire.wsgi.application'
